      ...
      <div class="row">
        <div class="col-lg-12 connectedSortable">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <p>
                <b>Pengguna <?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dihapus. <br>
                Dan semua artikel yang ditulis oleh <b><?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dipindahkan kepada:
              </p>
              <hr>
              ...
              <form method="post" action="<?php echo base_url('dashboard/pengguna_hapus_aksi'); ?>">
                ...
                <div class="form-group">
                  <input type="submit" value="Hapus Pengguna & Pindahkan Artikel" class="btn btn-block btn-primary">
                </div>
              </form>
