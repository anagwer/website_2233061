          ...
          <div class="copyright-box">
            <div class="socials">
              <ul>
                ...
                <li>
                  <a href="<?php echo $pengaturan->link_tiktok; ?>">
                    <span class="ico-circle"><i class="ion-social-tiktok"></i></span>
                  </a>
                </li>
              </ul>
            </div>
            <p class="copyright">
              &copy; Copyright <strong><?php echo $pengaturan->nama; ?></strong>. All Rights Reserved
            </p>
            <div class="credits">
